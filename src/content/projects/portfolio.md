...
## Tracking of choice Umami

Recently added a tracking solution to keep a tab on incoming and outgoing traffic. Since the goal was lightspeed and lightweight with the site, google analytics would have ben a total overkill. After a couple of searches found [Umami](umami.ts); a lightweight privacy first tracking solution that is just perfect for my needs.

To state it in their words, Umami is:
...
A 2KB tracking script, serious. No need for any cookie banners as no fingerprinting or personal data is gathered. It literally has all the basics and more, without the bloat. And better even, my lighthouse score were not affected at all. Still 100% score which was demand nr.1 So if you don't need to do any heavy campaign tracking with attributions or complicated funnels, I can surely recommend this as the perfect alternative.
